...
# Alternativ kann das Arbeitsverzeichnis auch über den Tab "Files" im Fenster unten links 
# gesetzt werden. Navigiert euch dazu erst in den gewünschten Ordner, klickt dann auf "More"
# und "Set As Working Directory". 
...
saveRDS(kafka_1, file="kafka.rds")
readRDS(file="kafka.rds")

# RData and rda : Save multiple objects in one file 
save(kafka_1, eltec, schiller, file="uebung.rda")
load(file="uebung.rda")
save(kafka_1, eltec, schiller, file="uebung.RData")
