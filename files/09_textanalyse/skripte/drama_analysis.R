...
# Dieses Skript reproduziert das Tutorial https://quadrama.github.io/DramaAnalysis/tutorial/3/index.html 
# zum Paket "DramaAnalaysis".
...
characterStatistics(d, normalize=FALSE)  %>%
  characterNames(d) %>%
