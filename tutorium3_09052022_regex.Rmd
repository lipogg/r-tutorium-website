---
title: "3. Sitzung: Reguläre Ausdrücke"
output: 
  html_document:
    toc: true
    toc_float: true
...
rapunzel_df <- readtext("files/03_regex/dateien/Rapunzel_(1850).txt") #df ist Standard-Abkürzung für dataframe
...
```{r }
rapunzel <- readLines("files/03_regex/dateien/Rapunzel_(1850).txt")
str(rapunzel)
```

Verständnisfrage: 

* Welche Struktur hat unser Datenobjekt "rapunzel" nach Einlesen des Märchens mithilfe der readLines Funktion? 
...
Siehe [Skript zur Übung](https://github.com/lipogg/r-tutorium/blob/c3b53ce1ae61459c7079f8b96cda70425c1aebe6/03_regex/skripte/tutorium3_09052022_uebung.R)
...
## [Skript zur Übung](https://github.com/lipogg/r-tutorium/blob/c3b53ce1ae61459c7079f8b96cda70425c1aebe6/03_regex/skripte/tutorium3_09052022_uebung.R)

Für Nutzer:innen ohne Zugriff auf das Repository:
```{r echo=FALSE}
xfun::embed_dir('files/03_regex', text="Zip-Ordner downloaden")
```

## [Hausaufgabe](https://github.com/lipogg/r-tutorium/tree/c3b53ce1ae61459c7079f8b96cda70425c1aebe6/03_uebung)

Für Nutzer:innen ohne Zugriff auf das Repository:
```{r echo=FALSE}
xfun::embed_dir('files/03_uebung', text="Zip-Ordner downloaden")
```
