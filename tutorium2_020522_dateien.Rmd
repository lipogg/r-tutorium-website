---
title: "2. Sitzung: Daten und Dateien"
output: 
  html_document:
    toc: true
    toc_float: true
...
Siehe [Skript zur Übung](https://github.com/lipogg/r-tutorium/blob/c3b53ce1ae61459c7079f8b96cda70425c1aebe6/02_daten-dateien/skripte/tutorium2_02052022_uebung.R) 
...
### 4.5 Daten aufbereiten und parsen 
...
## [Skript zur Übung](https://github.com/lipogg/r-tutorium/blob/c3b53ce1ae61459c7079f8b96cda70425c1aebe6/02_daten-dateien/skripte/tutorium2_02052022_uebung.R)

Für Nutzer:innen ohne Zugriff auf das Repository:
```{r echo=FALSE}
xfun::embed_dir('files/02_daten_und_dateien', text="Zip-Ordner downloaden")
```


## [Hausaufgabe](https://github.com/lipogg/r-tutorium/tree/c3b53ce1ae61459c7079f8b96cda70425c1aebe6/02_uebung)

Für Nutzer:innen ohne Zugriff auf das Repository:
```{r echo=FALSE}
xfun::embed_dir('files/02_uebung', text="Zip-Ordner downloaden")
```
